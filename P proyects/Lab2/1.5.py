...
while True: 
    try:
        n = str(input("Ingrese el nombre del usuario: "))
        id = int(input("Ingrese la ID del usuario: "))
        dd = int(input("Ingrese el dia de nacimiento del usuario: "))
        mm = int(input("Ingrese el mes de nacimiento del usuario: "))
        aa = int(input("Ingrese el año de nacimiento del usuario: "))
        cn = str(input("Ingrese la ciudad de nacimiento del usuario: "))
        t = int(input("Ingrese el telefono del usuario: "))
        em = str(input("Ingrese el email del usuario: "))
        cll = int(input("Ingrese la calle de residencia del usuario: "))
        n = str(input("Ingrese la nomenclatura de la residencia del usuario: "))
        b = str(input("Ingrese el barrio de residencia usuario: "))
        ...
        diru = Direccion(cll, n, b, c, e, a)
        usr1 = Usuario(n, id, fechau.formatof(), cn, t, em, diru.formatod())
        print(usr1.formatou())
    except ValueError:
        print("Información errónea. Intentelo nuevamente")
